...
public class PPayStation {
	...
	public void addAmount(Coin coin, PPrice currentPrice) {
		...
		if (currency == Currency.ValidCurrency.DKK) {
			...
			valueInCent = calculate(coin, currentPrice);
		} else {
			valueInCent = calculate(coin, null);
		}
	...
	public double calculate(Coin coin, PPrice price) {
		return Calculation.calculate(coin, price);
	}
