...
public class CreateProcedureDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public CreateProcedureDialog(SynchronizationController synchronizationController) {
		try {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				procedureNameTextField = new JTextField();
			...
			{
				pricePerHourTextField = new JTextField();
			...
			{
				employeeTypeRequiredTextField = new JTextField();
	...
	private void confirm() {
		try {
			if (regexChecker()) {
				procedureController.createProcedure(procedureNameTextField.getText(),
						BigDecimal.valueOf(Double.parseDouble(pricePerHourTextField.getText())),
