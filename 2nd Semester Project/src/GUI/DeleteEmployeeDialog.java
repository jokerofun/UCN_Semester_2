...
public class DeleteEmployeeDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DeleteEmployeeDialog(int employeeId, SynchronizationController synchronizationController) {
		try {
	...
	private void confirm(int employeeId) throws DataAccessException {
