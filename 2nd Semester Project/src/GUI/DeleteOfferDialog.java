...
public class DeleteOfferDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DeleteOfferDialog(int offerNumber, SynchronizationController synchronizationController) {
		try {
	...
	private void confirm(int offerNumber) throws DataAccessException {
		offerController.deleteOffer(offerNumber);
